...
class TestPeli(unittest.TestCase):
    ...
    def test_etsi_voittajaa_vaakarivi(self):
        ...
        self.assertEqual(self.peli.etsi_voittajaa((0, 4), "X"), True)
    ...
    def test_etsi_voittajaa_pystyrivi(self):
        ...
        self.assertEqual(self.peli.etsi_voittajaa((5, 3), "X"), True)
    ...
    def test_etsi_voittajaa_diagonaali_alas(self):
        ...
        self.assertEqual(self.peli.etsi_voittajaa((2, 2), "X"), True)
    ...
    def test_etsi_voittajaa_diagonaali_ylos(self):
        ...
        self.assertEqual(self.peli.etsi_voittajaa((3, 9), "X"), True)